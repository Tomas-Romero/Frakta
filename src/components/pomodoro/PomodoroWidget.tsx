...
export function PomodoroWidget() {
  ...
  return (
    <div className="fixed right-4 z-40 w-64 overflow-hidden rounded-xl border bg-card text-card-foreground shadow-lg bottom-[calc(5rem+env(safe-area-inset-bottom))] md:bottom-4">
